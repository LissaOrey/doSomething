...
const Game = (props) => {
    ...
    const gameOver = (copy) => {
        ...
        if (f[0][0] !== '' && f[0][1] !== '' && f[0][2] !== '' && f[0][3] !== '' && f[1][0] !== '' && f[1][1] !== '' && f[1][2] !== '' && f[1][3] !== '' && f[2][0] !== '' && f[2][1] !== '' && f[2][2] !== '' && f[2][3] !== '' && f[3][0] !== '' && f[3][1] !== '' && f[3][2] !== '' && f[3][3] !== '' && f[0][0] !== f[0][1] && f[0][0] !== f[1][0] && f[0][1] !== f[1][1] && f[0][1] !== f[0][2] && f[0][2] !== f[0][3] && f[0][2] !== f[1][2] && f[0][3] !== f[1][3] && f[1][0] !== f[1][1] && f[1][0] !== f[2][0] && f[1][1] !== f[1][2] && f[1][2] !== f[1][3] && f[1][1] !== f[2][1] && f[1][2] !== f[2][2] && f[1][3] !== f[2][3] && f[2][3] !== f[3][3] && f[3][2] !== f[3][3] && f[2][2] !== f[3][2] && f[2][1] !== f[2][2] && f[2][1] !== f[3][1] && f[3][1] !== f[3][2] && f[2][0] !== f[2][1] && f[2][0] !== f[3][0] && f[3][0] !== f[3][1] && f[2][2] !== f[2][3]) {
            setOpenPopup(true);
            bestScoreValue()
        }
    }
